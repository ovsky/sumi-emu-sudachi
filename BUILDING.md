...
<details><summary><i>Windows System</i></summary>
<p>
...
```cmd
git clone https://github.com/sumi/sumi.git --recursive
```
...
> If you get any errors on "Intel® HAXM" or "Android Emulator Hypervisor Driver for AMD Processors", you can safely ignore them as they won't be used for Sumi.

</p>
</details>

Import the project by clicking on the `Open` icon, then in the file picker choose the `sumi` folder you just cloned in the steps above:
...
```properties
cmake.dir=C\:\\Users\\sumi\\AppData\\Local\\Android\\Sdk\\cmake\\3.18.1
```
...
In an **administrator** terminal prompt navigate to the Sumi root project folder and run:
