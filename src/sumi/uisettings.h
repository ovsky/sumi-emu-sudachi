...
const std::array<Shortcut, 28> default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Exit sumi")).toStdString(),                QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string("Ctrl+Q"),  std::string("Home+Minus"), Qt::WindowShortcut, false}},
