...
var sumi_key_callbacks = [];

(function() {
    class WindowNX {
        constructor() {
            sumi_key_callbacks[1] = function() { window.history.back(); };
            sumi_key_callbacks[2] = function() { window.nx.endApplet(); };
        }
    ...
    class WindowNXFooter {
        setAssign(key, label, func, option) {
            ...
            switch (key) {
                case "A":
                    sumi_key_callbacks[0] = func;
                    break;
                case "B":
                    sumi_key_callbacks[1] = func;
                    break;
                case "X":
                    sumi_key_callbacks[2] = func;
                    break;
                case "Y":
                    sumi_key_callbacks[3] = func;
                    break;
                case "L":
                    sumi_key_callbacks[6] = func;
                    break;
                case "R":
                    sumi_key_callbacks[7] = func;
                    break;
            }
        }
        ...
        unsetAssign(key) {
            ...
            switch (key) {
                case "A":
                    sumi_key_callbacks[0] = function() {};
                    break;
                case "B":
                    sumi_key_callbacks[1] = function() {};
                    break;
                case "X":
                    sumi_key_callbacks[2] = function() {};
                    break;
                case "Y":
                    sumi_key_callbacks[3] = function() {};
                    break;
                case "L":
                    sumi_key_callbacks[6] = function() {};
                    break;
                case "R":
                    sumi_key_callbacks[7] = function() {};
                    break;
            }
        }
    }
