...
#include "sumi/configuration/config.h"
...
const std::array<UISettings::Shortcut, 23> Config::default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Exit sumi")),                QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")), {QStringLiteral("Ctrl+Q"),  QStringLiteral("Home+Minus"), Qt::WindowShortcut, false}},
    ...
    FS::SetSumiPath(
        ...
        qt_config
            ->value(QStringLiteral("nand_directory"),
                    QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::NANDDir)))
            .toString()
            .toStdString());
    FS::SetSumiPath(
        FS::SumiPath::SDMCDir,
        qt_config
            ->value(QStringLiteral("sdmc_directory"),
                    QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::SDMCDir)))
            .toString()
            .toStdString());
    FS::SetSumiPath(
        FS::SumiPath::LoadDir,
        qt_config
            ->value(QStringLiteral("load_directory"),
                    QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::LoadDir)))
            .toString()
            .toStdString());
    FS::SetSumiPath(
        FS::SumiPath::DumpDir,
        qt_config
            ->value(QStringLiteral("dump_directory"),
                    QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::DumpDir)))
            .toString()
            .toStdString());
    FS::SetSumiPath(FS::SumiPath::TASDir,
                    qt_config
                        ->value(QStringLiteral("tas_directory"),
                                QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::TASDir)))
                        .toString()
                        .toStdString());
...
void Config::ReadScreenshotValues() {
    ...
    FS::SetSumiPath(
        FS::SumiPath::ScreenshotsDir,
        qt_config
            ->value(QStringLiteral("screenshot_path"),
                    QString::fromStdString(FS::GetSumiPathString(FS::SumiPath::ScreenshotsDir)))
            .toString()
            .toStdString());
