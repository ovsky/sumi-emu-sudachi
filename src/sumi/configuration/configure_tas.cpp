...
#include "sumi/configuration/configure_tas.h"
...
void ConfigureTasDialog::LoadConfiguration() {
    ui->tas_path_edit->setText(
        QString::fromStdString(Common::FS::GetSumiPathString(Common::FS::SumiPath::TASDir)));
...
void ConfigureTasDialog::ApplyConfiguration() {
    Common::FS::SetSumiPath(Common::FS::SumiPath::TASDir, ui->tas_path_edit->text().toStdString());
