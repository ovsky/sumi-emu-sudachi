...
void ConfigureWeb::RetranslateUI() {
    ...
    ui->web_signup_link->setText(
        tr("<a href='https://profile.sumi-emu.org/'><span style=\"text-decoration: underline; "
           "color:#039be5;\">Sign up</span></a>"));

    ui->web_token_info_link->setText(
        tr("<a href='https://sumi-emu.org/wiki/sumi-web-service/'><span "
...
void ConfigureWeb::SetConfiguration() {
    ...
    ui->edit_token->setText(QString::fromStdString(GenerateDisplayToken(
        Settings::values.sumi_username.GetValue(), Settings::values.sumi_token.GetValue())));
...
void ConfigureWeb::ApplyConfiguration() {
    ...
    if (user_verified) {
        Settings::values.sumi_username =
            UsernameFromDisplayToken(ui->edit_token->text().toStdString());
        Settings::values.sumi_token =
