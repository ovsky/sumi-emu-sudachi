...
void DiscordImpl::UpdateGameStatus(bool use_default) {
    const std::string default_text = "sumi is an emulator for the Nintendo Switch";
    const std::string default_image = "sumi_logo_ea";
...
void DiscordImpl::Update() {
    ...
    if (system.IsPoweredOn()) {
        ...
        // Used to format Icon URL for sumi website game compatibility page
        std::string icon_name = GetGameString(game_title);
        game_url = fmt::format("https://sumi-emu.org/images/game/boxart/{}.png", icon_name);
