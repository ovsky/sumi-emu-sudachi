...
/*
To play back TAS scripts on Sumi, select the folder with scripts in the configuration menu below
...
After placing the file at the correct location, it can be read into Sumi with the (default) hotkey
