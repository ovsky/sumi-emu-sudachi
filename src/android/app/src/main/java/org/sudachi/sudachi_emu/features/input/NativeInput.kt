...
object NativeInput {
     ...
     */
    external fun onGamePadAxisEvent(
        guid: String,
        port: Int,
        axis: Int,
        value: Float,
     ...
     * @param action Mask identifying which action is happening (button pressed down, or button released).
     */
    fun onOverlayButtonEvent(
        port: Int,
        button: NativeButton,
        action: Int,
    ) = onOverlayButtonEventImpl(port, button.int, action)

    private external fun onOverlayButtonEventImpl(
        port: Int,
        buttonId: Int,
        action: Int,
    )
    ...
    fun getButtonParam(
        playerIndex: Int,
        button: NativeButton,
    ): ParamPackage = ParamPackage(getButtonParamImpl(playerIndex, button.int))

    private external fun getButtonParamImpl(
        playerIndex: Int,
        buttonId: Int,
    ): String
    ...
    private external fun setButtonParamImpl(
        playerIndex: Int,
        buttonId: Int,
        param: String,
    )
    ...
    fun getStickParam(
        playerIndex: Int,
        stick: NativeAnalog,
    ): ParamPackage = ParamPackage(getStickParamImpl(playerIndex, stick.int))

    private external fun getStickParamImpl(
        playerIndex: Int,
        stickId: Int,
    ): String
    ...
    private external fun setStickParamImpl(
        playerIndex: Int,
        stickId: Int,
        param: String,
    )
     ...
     */
    fun getButtonName(param: ParamPackage): ButtonName = ButtonName.from(getButtonNameImpl(param.serialize()))
     ...
     */
    fun getStyleIndex(playerIndex: Int): NpadStyleIndex = NpadStyleIndex.from(getStyleIndexImpl(playerIndex))
    ...
    fun setStyleIndex(
        playerIndex: Int,
        style: NpadStyleIndex,
    ) = setStyleIndexImpl(playerIndex, style.int)

    private external fun setStyleIndexImpl(
        playerIndex: Int,
        styleIndex: Int,
    )
     ...
     */
    fun connectControllers(
        playerIndex: Int,
        connected: Boolean = true,
    ) {
        val connectedControllers =
