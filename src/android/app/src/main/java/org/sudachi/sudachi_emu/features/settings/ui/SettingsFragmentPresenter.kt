...
class SettingsFragmentPresenter(
    ...
    private fun getPlayerProfileString(player: Int): String = context.getString(R.string.player_num_profile, player)
    ...
    private fun addInputPlayer(
        sl: ArrayList<SettingsItem>,
        playerIndex: Int,
    ) {
        sl.apply {
            val connectedSetting =
                object : AbstractBooleanSetting {
                    override val key = "connected"

                    override fun getBoolean(needsGlobal: Boolean): Boolean = NativeInput.getIsConnected(playerIndex)

                    override fun setBoolean(value: Boolean) = NativeInput.connectControllers(playerIndex, value)
            ...
            addAbstract(
                IntSingleChoiceSetting(
                    ...
                    choices =
                        styleTags
                            .map { context.getString(it.nameId) }
                            .toTypedArray(),
            ...
            val prettyAutoMappingControllerList =
                InputHandler.registeredControllers
                    .mapNotNull {
            ...
            val vibrationStrengthSetting =
                object : AbstractIntSetting {
                    override val key = ""

                    override fun getInt(needsGlobal: Boolean): Int = NativeConfig.getInputSettings(true)[playerIndex].vibrationStrength
    ...
    private fun getStickIntSettingFromParam(
        ...
        object : AbstractIntSetting {
            ...
            override fun getInt(needsGlobal: Boolean): Int = (params.get(paramName, defaultValue) * 100).toInt()
    ...
    private fun getExtraStickSettings(
        ...
        val out =
            mutableListOf<SettingsItem>().apply {
        ...
        sl.apply {
            val theme: AbstractIntSetting =
                object : AbstractIntSetting {
                    ...
                    override fun getValueAsString(needsGlobal: Boolean): String = IntSetting.THEME.getValueAsString()
            ...
            val themeMode: AbstractIntSetting =
                object : AbstractIntSetting {
                    ...
                    override fun getValueAsString(needsGlobal: Boolean): String = IntSetting.THEME_MODE.getValueAsString()
            ...
            val blackBackgrounds: AbstractBooleanSetting =
                object : AbstractBooleanSetting {
                    override fun getBoolean(needsGlobal: Boolean): Boolean = BooleanSetting.BLACK_BACKGROUNDS.getBoolean()
                    ...
                    override fun getValueAsString(needsGlobal: Boolean): String = BooleanSetting.BLACK_BACKGROUNDS.getValueAsString()
