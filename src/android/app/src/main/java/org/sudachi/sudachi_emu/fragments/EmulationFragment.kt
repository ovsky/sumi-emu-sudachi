...
class EmulationFragment :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intentUri != null) {
            intentGame =
                if (Game.extensions.contains(FileUtil.getExtension(intentUri))) {
    ...
    override fun onViewCreated(
        ...
        binding.inGameMenu
            .getHeaderView(0)
            .findViewById<TextView>(R.id.text_game_title)
            .text =
            game.title
            ...
            when (it.itemId) {
                ...
                R.id.menu_toggle_controls -> {
                    ...
                    overlayControlData.forEachIndexed { i, _ ->
                        optionsArray[i] = overlayControlData
                            .firstOrNull { data ->
