...
class SettingsAdapter(
    ...
    fun onIntSingleChoiceClick(
        item: IntSingleChoiceSetting,
        position: Int,
    ) {
        SettingsDialogFragment
            .newInstance(
    ...
    fun onInputProfileClick(
        item: InputProfileSetting,
        position: Int,
    ) {
                    ...
                    if (params.has("code") || params.has("button") || params.has("hat")) {
                        ...
                        val thresholdSetting =
                            object : AbstractIntSetting {
                                ...
                                override fun getInt(needsGlobal: Boolean): Int = (params.get("threshold", 0.5f) * 100).toInt()
    ...
    fun onStringInputClick(
        item: StringInputSetting,
        position: Int,
    ) {
        SettingsDialogFragment
            .newInstance(
    ...
    private class DiffCallback : DiffUtil.ItemCallback<SettingsItem>() {
        ...
        ): Boolean = oldItem.setting.key == newItem.setting.key
