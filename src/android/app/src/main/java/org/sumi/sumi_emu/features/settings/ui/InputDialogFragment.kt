...
class InputDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val playButtonMapAnimation = { twoDirections: Boolean ->
            ...
            stickAnimation.registerAnimationCallback(
            ...
            buttonAnimation.registerAnimationCallback(
                object : Animatable2.AnimationCallback() {
                    override fun onAnimationEnd(drawable: Drawable?) {
        ...
        when (val setting = inputSetting) {
            ...
            is ModifierInputSetting -> {
                builder
                    .setTitle(getString(R.string.map_control, setting.title))
    ...
    private fun isInputAcceptable(params: ParamPackage): Boolean {
        ...
        val guidMatch =
            params.get("guid", "") == currentDevice.get("guid", "") ||
