...
object NativeConfig {
     ...
     */
    @Synchronized
    external fun initializePerGameConfig(
        programId: String,
        fileName: String,
    )
    ...
    @Synchronized
    external fun getByte(
        key: String,
        needsGlobal: Boolean,
    ): Byte

    @Synchronized
    external fun setByte(
        key: String,
        value: Byte,
    )

    @Synchronized
    external fun getShort(
        key: String,
        needsGlobal: Boolean,
    ): Short

    @Synchronized
    external fun setShort(
        key: String,
        value: Short,
    )
    ...
    @Synchronized
    external fun getLong(
        key: String,
        needsGlobal: Boolean,
    ): Long

    @Synchronized
    external fun setLong(
        key: String,
        value: Long,
    )
     ...
     */
    @Synchronized
    external fun setDisabledAddons(
        programId: String,
        disabledAddons: Array<String>,
    )
    ...
    @Synchronized
    external fun setInputSettings(
        value: Array<PlayerInput>,
        global: Boolean,
    )
