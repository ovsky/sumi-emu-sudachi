...
object NativeLibrary {
    ...
    external fun doesUpdateMatchProgram(
        programId: String,
        updatePath: String,
    ): Boolean
     ...
     */
    external fun getPatchesForFile(
        path: String,
        programId: String,
    ): Array<Patch>?
     ...
     */
    external fun verifyInstalledContents(callback: (max: Long, progress: Long) -> Boolean): Array<String>
