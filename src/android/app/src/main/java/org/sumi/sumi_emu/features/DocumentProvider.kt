...
class DocumentProvider : DocumentsProvider() {
    ...
    companion object {
        private val DEFAULT_ROOT_PROJECTION: Array<String> =
            arrayOf(
        ...
        private val DEFAULT_DOCUMENT_PROJECTION: Array<String> =
            arrayOf(
     ...
     */
    private fun getDocumentId(file: File): String = "$ROOT_ID/${file.toRelativeString(baseDirectory)}"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        cursor.newRow().apply {
            ...
            add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_sumi_round)
        }
    ...
    override fun isChildDocument(
        ...
        documentId: String?,
    ): Boolean = documentId?.startsWith(parentDocumentId!!) ?: false
