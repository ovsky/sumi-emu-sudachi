...
bool ProfileExistsInFilesystem(std::string_view profile_name) {
    return Common::FS::Exists(Common::FS::GetSumiPath(Common::FS::SumiPath::ConfigDir) / "input" /
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_isHandheldOnly(JNIEnv* env,
                                                                           jobject j_obj) {
    return IsHandheldOnly();
}

void Java_org_sumi_sumi_1emu_features_input_NativeInput_onGamePadButtonEvent(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onGamePadAxisEvent(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onGamePadMotionEvent(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onReadNfcTag(JNIEnv* env, jobject j_obj,
                                                                     jbyteArray j_data) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onRemoveNfcTag(JNIEnv* env, jobject j_obj) {
    if (EmulationSession::GetInstance().IsRunning()) {
        EmulationSession::GetInstance().GetInputSubsystem().GetVirtualAmiibo()->CloseAmiibo();
    }
}

void Java_org_sumi_sumi_1emu_features_input_NativeInput_onTouchPressed(JNIEnv* env, jobject j_obj,
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onTouchMoved(JNIEnv* env, jobject j_obj,
                                                                     jint j_id, jfloat j_x_axis,
                                                                     jfloat j_y_axis) {
    if (EmulationSession::GetInstance().IsRunning()) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onTouchReleased(JNIEnv* env, jobject j_obj,
                                                                        jint j_id) {
    if (EmulationSession::GetInstance().IsRunning()) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onOverlayButtonEventImpl(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onOverlayJoystickEventImpl(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_onDeviceMotionEvent(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_reloadInputDevices(JNIEnv* env,
                                                                           jobject j_obj) {
    EmulationSession::GetInstance().System().HIDCore().ReloadInputDevices();
}

void Java_org_sumi_sumi_1emu_features_input_NativeInput_registerController(JNIEnv* env,
                                                                           jobject j_obj,
                                                                           jobject j_device) {
    EmulationSession::GetInstance().GetInputSubsystem().GetAndroid()->RegisterController(j_device);
}

jobjectArray Java_org_sumi_sumi_1emu_features_input_NativeInput_getInputDevices(JNIEnv* env,
                                                                                jobject j_obj) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_loadInputProfiles(JNIEnv* env,
                                                                          jobject j_obj) {
    map_profiles.clear();
    const auto input_profile_loc =
        Common::FS::GetSumiPath(Common::FS::SumiPath::ConfigDir) / "input";
...
jobjectArray Java_org_sumi_sumi_1emu_features_input_NativeInput_getInputProfileNames(
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_isProfileNameValid(JNIEnv* env,
                                                                               jobject j_obj,
                                                                               jstring j_name) {
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_createProfile(JNIEnv* env,
                                                                          jobject j_obj,
                                                                          jstring j_name,
                                                                          jint j_player_index) {
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_deleteProfile(JNIEnv* env,
                                                                          jobject j_obj,
                                                                          jstring j_name,
                                                                          jint j_player_index) {
    auto profile_name = Common::Android::GetJString(env, j_name);
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_loadProfile(JNIEnv* env, jobject j_obj,
                                                                        jstring j_name,
                                                                        jint j_player_index) {
    auto profile_name = Common::Android::GetJString(env, j_name);
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_saveProfile(JNIEnv* env, jobject j_obj,
                                                                        jstring j_name,
                                                                        jint j_player_index) {
    auto profile_name = Common::Android::GetJString(env, j_name);
    return SaveProfile(profile_name, j_player_index);
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_loadPerGameConfiguration(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_beginMapping(JNIEnv* env, jobject j_obj,
                                                                     jint jtype) {
    EmulationSession::GetInstance().GetInputSubsystem().BeginMapping(
        static_cast<InputCommon::Polling::InputType>(jtype));
}

jstring Java_org_sumi_sumi_1emu_features_input_NativeInput_getNextInput(JNIEnv* env,
                                                                        jobject j_obj) {
    return Common::Android::ToJString(
        env, EmulationSession::GetInstance().GetInputSubsystem().GetNextInput().Serialize());
}

void Java_org_sumi_sumi_1emu_features_input_NativeInput_stopMapping(JNIEnv* env, jobject j_obj) {
    EmulationSession::GetInstance().GetInputSubsystem().StopMapping();
}

void Java_org_sumi_sumi_1emu_features_input_NativeInput_updateMappingsWithDefaultImpl(
...
jstring Java_org_sumi_sumi_1emu_features_input_NativeInput_getButtonParamImpl(JNIEnv* env,
                                                                              jobject j_obj,
                                                                              jint j_player_index,
                                                                              jint j_button) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_setButtonParamImpl(
...
jstring Java_org_sumi_sumi_1emu_features_input_NativeInput_getStickParamImpl(JNIEnv* env,
                                                                             jobject j_obj,
                                                                             jint j_player_index,
                                                                             jint j_stick) {
    return Common::Android::ToJString(env, EmulationSession::GetInstance()
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_setStickParamImpl(
...
jint Java_org_sumi_sumi_1emu_features_input_NativeInput_getButtonNameImpl(JNIEnv* env,
                                                                          jobject j_obj,
                                                                          jstring j_param) {
...
jintArray Java_org_sumi_sumi_1emu_features_input_NativeInput_getSupportedStyleTagsImpl(
...
jint Java_org_sumi_sumi_1emu_features_input_NativeInput_getStyleIndexImpl(JNIEnv* env,
                                                                          jobject j_obj,
                                                                          jint j_player_index) {
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_setStyleIndexImpl(JNIEnv* env,
                                                                          jobject j_obj,
                                                                          jint j_player_index,
                                                                          jint j_style_index) {
    auto& hid_core = EmulationSession::GetInstance().System().HIDCore();
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_isControllerImpl(JNIEnv* env,
                                                                             jobject j_obj,
                                                                             jstring jparams) {
...
jboolean Java_org_sumi_sumi_1emu_features_input_NativeInput_getIsConnected(JNIEnv* env,
                                                                           jobject j_obj,
                                                                           jint j_player_index) {
    auto& hid_core = EmulationSession::GetInstance().System().HIDCore();
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_connectControllersImpl(
...
void Java_org_sumi_sumi_1emu_features_input_NativeInput_resetControllerMappings(
    JNIEnv* env, jobject j_obj, jint j_player_index) {
    // Clear all previous mappings
    for (int button_id = 0; button_id < Settings::NativeButton::NumButtons; ++button_id) {
        ApplyControllerConfig(j_player_index, [&](Core::HID::EmulatedController* controller) {
